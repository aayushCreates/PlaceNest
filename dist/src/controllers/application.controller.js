...
exports.getAllJobApplications = exports.updateApplicationStatus = exports.getStudentApplications = exports.jobApplication = void 0;
    ...
    try {
        ...
        if (!user || (user.role !== "COMPANY" && user.role !== "COORDINATOR")) {
            return res
                ...
                .json({
                success: false,
                message: "Only companies and coordinators can get the job applications",
            });
        }
